...
params_arr=(checkpoint_path log_file mode batch_size hidden_size learning_rate in_keep_prob out_keep_prob num_layers max_gradient_norm negative_sampling_rate encoder_type cell_type cbase state_is_tuple)
