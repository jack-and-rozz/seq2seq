...
params_arr=(mode checkpoint_path log_file dataset w_vocab_size c_vocab_size batch_size hidden_size learning_rate in_keep_prob out_keep_prob num_layers max_gradient_norm encoder_type c_encoder_type cell_type cbase wbase state_is_tuple max_a_sent_length max_d_sent_length max_a_word_length n_triples)
